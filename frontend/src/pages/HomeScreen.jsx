...
const UserCard = ({ user }) => (
    <Link to={`/users/${user._id}`} className="bg-white border rounded-lg p-6 flex flex-col justify-between shadow-sm hover:shadow-lg transition-shadow duration-300 hover:border-blue-500">
        ...
        <div className="mt-6"><div className="flex justify-between items-center text-sm text-gray-500"><span>{user.swapsCompleted} swaps</span><span>1-2hr response</span></div><div className="w-full mt-2 text-center bg-gray-800 text-white py-2 rounded-lg hover:bg-gray-700 font-semibold transition-colors">View Profile</div></div>
    </Link>
);
